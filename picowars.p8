...
function draw_campaign()
  ...
  if current_level.index > 1 and current_level.index < #campaign_levels then
    if not map_move_timer then
      map_move_timer = map_move_timer_duration
    end
    if map_move_timer > 0 then 
      x_offset = (campaign_levels[current_level.index - 1].map_pos[1] - current_level.map_pos[1]) * (map_move_timer / map_move_timer_duration)
      y_offset = (campaign_levels[current_level.index - 1].map_pos[2] - current_level.map_pos[2]) * (map_move_timer / map_move_timer_duration)
      map_move_timer -= delta_time
    end
  end
...

...

...
__gff__

...

...

...

...

__music__
01 10460a44
02 10460b44
00 50464a44
